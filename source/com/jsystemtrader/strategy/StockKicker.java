...
/**
 * This sample strategy trades Microsoft stock using moving average crossover
 ...
 */
public class StockKicker extends Strategy {
    ...
    public StockKicker() throws JSystemTraderException {
        ...
        setStrategy(contract, minimumQuoteHistorySize, PriceBar.BAR_1_MINUTE, true, 100);
